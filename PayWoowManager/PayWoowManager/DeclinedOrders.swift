...
//                        
//                        if selected == 0 {
//                            ForEach(self.bayiiOrder.declinedOrders){ order in
...
//                    
//                    
//                    if self.bayiiOrder.declinedOrders.isEmpty {
//                        VStack(spacing: 20){
//                            Image("emptyOrder")
//                                .resizable()
//                                .scaledToFit()
...
//            self.bayiiOrder.getDeclinedOrders(dealler: self.dealler)
//        }
//    }
//}
//
