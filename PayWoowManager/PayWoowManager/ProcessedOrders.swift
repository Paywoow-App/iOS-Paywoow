...
//                                
//                                if selected == 0 {
//                                    ForEach(self.bayiiOrder.processedOrders){ order in
...
//                            
//                            
//                            if self.bayiiOrder.processedOrders.isEmpty {
//                                VStack(spacing: 20){
//                                    Image("emptyOrder")
//                                        .resizable()
//                                        .scaledToFit()
...
//                self.bayiiOrder.getProcessedOrders(dealler: self.dealler)
//            }
//    }
//}
//
