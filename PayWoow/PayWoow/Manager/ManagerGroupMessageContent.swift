...
struct ManagerGroupMessageContent: View {
                ...
                if streamerID != "" {
                    HStack{
                        ...
                        VStack(alignment: .center, spacing: 12){
                            ...
                            if streamerProcess == 0 {
                                HStack{
                                    Button {
                                        ref.collection("Agencies").document(agencyID).collection("StreamerDemo").document(message).setData(["process" : 2], merge: true)
                                    } label: {
                                        ZStack{
                                    ...
                                    Button {
                                        ref.collection("Agencies").document(agencyID).collection("StreamerDemo").document(message).setData(["process" : 1], merge: true)
                                    } label: {
                                        ZStack{
                                            RoundedRectangle(cornerRadius: 4)
                                                .fill(Color.white)
