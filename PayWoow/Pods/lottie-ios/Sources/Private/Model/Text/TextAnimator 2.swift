...
final class TextAnimator: Codable {
  ...
  required init(from decoder: Decoder) throws {
    ...
    fillColor = try animatorContainer.decodeIfPresent(KeyframeGroup<ColorLottie>.self, forKey: .fillColor)
    strokeColor = try animatorContainer.decodeIfPresent(KeyframeGroup<ColorLottie>.self, forKey: .strokeColor)
  ...
  /// Stroke Color
  let strokeColor: KeyframeGroup<ColorLottie>?

  /// Fill Color
  let fillColor: KeyframeGroup<ColorLottie>?
