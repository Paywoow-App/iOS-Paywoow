...
extension ColorLottie: Interpolatable {
  ...
  func interpolateTo(_ to: ColorLottie, amount: CGFloat, spatialOutTangent _: CGPoint?, spatialInTangent _: CGPoint?) -> ColorLottie {
    ColorLottie(
