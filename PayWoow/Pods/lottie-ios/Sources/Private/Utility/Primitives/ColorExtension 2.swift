...
extension ColorLottie {
  ...
  var cgColorValue: CGColor {
    ...
    return CGColor(colorSpace: colorspace, components: [CGFloat(r), CGFloat(g), CGFloat(b), CGFloat(a)]) ?? ColorLottie.clearColor
  }
}
