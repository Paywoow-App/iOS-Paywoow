...
public final class GradientValueProvider: AnyValueProvider {
  ...
  public typealias ColorsValueBlock = (CGFloat) -> [ColorLottie]
  ...
  private func value(from colors: [ColorLottie], locations: [Double]) -> [Double] {
