...
#ifndef ID_CARD_DETECTION_IOS_CNN_SWIFT_H
#define ID_CARD_DETECTION_IOS_CNN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="id_card_detection_ios_cnn",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC25id_card_detection_ios_cnn9GuideView") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
SWIFT_CLASS("_TtC25id_card_detection_ios_cnn19IDCardDetectionView") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface IDCardDetectionView : UIView <AVCapturePhotoCaptureDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
