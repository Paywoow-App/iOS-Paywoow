...
#ifndef ID_CARD_DETECTION_IOS_SWIFT_H
#define ID_CARD_DETECTION_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="id_card_detection_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC21id_card_detection_ios8HintView")
...
SWIFT_CLASS("_TtC21id_card_detection_ios19IDCardDetectionView")
...
SWIFT_CLASS("_TtC21id_card_detection_ios11OverlayView")
